...
" 
" let s:dark_gray = [236, "#212121"]
" let s:dark_gray = [236, "#2a252d"]
let s:dark_gray = [236, "#252126"]
let s:mid_gray = [102, "#878787"]
" let s:default_white = [231, "#FFFFFF"]
" let s:default_white = [231, "#efefef"]
let s:default_white = [231, "#bbb"]
...
let s:pink = [218, "#d77fdf"]
" let s:pink = [218, "#ff7ce9"]
" let s:light_blue = [159, "#afffff"]
" let s:light_blue = [159, "#aaafff"]
" let s:light_blue = [159, "#67d3cc"]
let s:light_blue = [159, "#bceaaa"]
...
call <SID>set_hi("goTodo", s:gray_purple, s:none, "NONE")
