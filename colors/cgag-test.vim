...
elseif &background == "dark"
    hi Boolean gui=NONE guifg=#44a2ca guibg=NONE
    ...
    hi Conditional gui=NONE guifg=#4fa7c9 guibg=NONE
    ...
    hi Normal gui=NONE guifg=#eff9e7 guibg=#1d3b4e
    hi Number gui=NONE guifg=#44a2ca guibg=NONE
    ...
    hi Special gui=NONE guifg=#7dca80 guibg=NONE
    ...
    hi Statement gui=NONE guifg=#7dca80 guibg=NONE
    hi StatusLine gui=NONE guifg=#9e9e9e guibg=#262626
    hi StatusLineNC gui=NONE guifg=#707070 guibg=#262626
    hi StorageClass gui=NONE guifg=#5eed89 guibg=NONE
    hi String gui=NONE guifg=#44a2ca guibg=NONE
    ...
    hi Todo gui=standout guifg=NONE guibg=NONE
    hi Type gui=NONE guifg=#3bb041 guibg=NONE
    hi Underlined gui=NONE guifg=NONE guibg=NONE
