...
" GUI colours
let s:g0 = 'fffee0' " color bg
let s:g1 = 'f0f0e1'
let s:g2 = 'b5b5aa'
let s:g3 = '9e9e95'
let s:g4 = '8a8a81'
let s:g5 = '606060' " foreground normal text
let s:g6 = '3b3b37'
let s:g7 = '2b2b2b'
let s:g8 = 'f55050'
let s:g9 = 'e06a26'
let s:gA = 'd4ac35'
" let s:gB = '219e21' " TODO(cgag): I think this is green and for try/break/swithc, pointers: &/*
let s:gB = '1d6d25' " TODO(cgag): I think this is green and for try/break/swithc, pointers: &/*
let s:gC = s:gB " keywords (pub, fn, const, var)
" let s:gC = '1e9191' " keywords (pub, fn, const, var)
let s:gD = '468dd4'
let s:gE = 'a26fbf'
let s:gF = 'd46a84'
...
" TODO(cgag): change colors for things other than neovim as well
" neovim colours
if has('nvim')
