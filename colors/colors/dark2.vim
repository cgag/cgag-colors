...
" Last Updated: Sun 07 Jun 2020 06:59:26 PM EDT
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi ErrorMsg guifg=#ebebeb guibg=#00ff00 guisp=NONE gui=reverse cterm=reverse
  ...
  hi Constant guifg=#5C9062 guibg=NONE guisp=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi ErrorMsg ctermfg=255 ctermbg=46 cterm=reverse
