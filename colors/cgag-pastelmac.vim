...
let g:colors_name='cgag-pastelmac'

let s:brown           = { "gui": "#a39077", "cterm": "12"   }
let s:bgblue          = { "gui": "#eaf0f0", "cterm": "0"   }
" let s:bgblue          = { "gui": "#ddeded", "cterm": "0"   }
let s:black           = { "gui": "#000000", "cterm": "0"   }
let s:string           = { "gui": "#606060", "cterm": "0"   }
...
let s:light_cyan      = { "gui": "#049b9d", "cterm": "6"  }
...
let s:status_line_active         = s:cyan
...
call s:h("Normal",        {"bg": s:bg, "fg": s:norm})
call s:h("Noise",         {"bg": s:bg, "fg": s:norm})
" call s:h("Cursor",        {"bg": s:green, "fg": s:green})
call s:h("Comment",       {"fg": s:cyan, "cterm": "italic"})
call s:h("Function",      {"fg": s:norm, "cterm": "bold"})

call s:h("Constant",      {"bg": s:bg, "fg": s:norm})
...
call s:h("Todo",          {"fg": s:comment, "bg": s:bg, "gui": "bold", "cterm": "bold"})
...
call s:h("StatusLine",      {"cterm": "underline", "bg": s:light_blue, "fg": s:status_line_nc})
call s:h("StatusLineNC",        {"bg": s:bg, "fg": s:status_line})
...
call s:h("Pmenu",         {"fg": s:norm, "bg": s:light_blue})
